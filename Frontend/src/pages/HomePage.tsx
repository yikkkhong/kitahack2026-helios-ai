...
import { CloudSun, ArrowRight, Coins, Globe, Cpu, Menu, X, Sparkles, Activity } from "lucide-react";
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden selection:bg-cyan-500 selection:text-white font-sans">
      ...
      >
        <div className="max-w-7xl mx-auto px-6 flex justify-between items-center">
          <div className="flex items-center gap-2 font-bold text-2xl tracking-tighter drop-shadow-lg">
            ...
            HELIOS <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-500">AI</span>
          </div>

          <div className="hidden md:flex gap-8 text-xs font-bold uppercase tracking-widest text-gray-400">
            <a href="#" className="hover:text-cyan-400 transition-colors">The Protocol</a>
            <a href="#" className="hover:text-cyan-400 transition-colors">3D Digital Twin</a>
            <a href="#" className="hover:text-cyan-400 transition-colors">ERU Tokenomics</a>
          </div>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 mt-16 max-w-4xl mx-auto">
          ...
          <h1 className="text-5xl md:text-7xl font-extrabold tracking-tighter mb-6 bg-clip-text text-transparent bg-gradient-to-r from-white via-cyan-100 to-gray-400 animate-in fade-in slide-in-from-bottom-6 duration-700 leading-tight">
            ...
            <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-600">Liquid Asset.</span>
          </h1>
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto mb-12 font-medium leading-relaxed animate-in fade-in slide-in-from-bottom-8 duration-1000">
            The first RWA-backed solar tokenization platform. Hedge against inflation, eliminate sunk costs, and trade your energy yield in real-time.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-5 justify-center items-center animate-in fade-in slide-in-from-bottom-10 duration-1000">
            ...
            >
              ...
              <span className="flex items-center gap-2 relative z-10">
                Start AI Assessment <ArrowRight className="w-4 h-4 group-hover:translate-x-1 transition-transform" />
              </span>
            </button>
      ...
      {/* --- Bento Gri d(Strictly align the 3 core steps) --- */}
      <section className="py-24 bg-black px-6 relative z-10">
        <div className="max-w-7xl mx-auto">
          <div className="mb-16 text-center md:text-left">
            <h2 className="text-3xl md:text-5xl font-bold mb-4 tracking-tight">
              An End-to-End <br/> <span className="text-cyan-400">Financial Engine.</span>
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-8 hover:border-cyan-500/30 transition-all duration-500 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Step 1: AI Financial Oracle</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Our Gemini-powered engine analyzes your constraints, forecasts 10-year yields, and structures your optimal ERU tokenomics before a single panel is mounted.
              </p>
            </div>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-8 hover:border-blue-500/30 transition-all duration-500 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Step 2: 3D Digital Twin</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Experience your physical asset in a 1:1 immersive 3D space. Validated by Google Maps Photorealistic 3D Tiles and Cesium architecture.
              </p>
            </div>
            ...
            <div className="bg-zinc-900/40 backdrop-blur-md border border-white/5 rounded-[2rem] p-8 hover:border-purple-500/30 transition-all duration-500 group">
              ...
              <h3 className="text-xl font-bold mb-3 text-white">Step 3: ERU Assetization</h3>
              <p className="text-gray-400 text-sm leading-relaxed">
                Your solar output is minted into Energy Revenue Units (ERU). Liquidate for emergency cash, or hold to hedge against rising utility rates.
              </p>
            </div>
            ...
            <div className="col-span-1 md:col-span-3 bg-gradient-to-br from-zinc-900/80 to-black border border-white/5 rounded-[2rem] p-8 md:p-12 relative overflow-hidden group flex flex-col md:flex-row items-center justify-between min-h-[250px]">
              ...
              <div className="relative z-10 max-w-xl mb-8 md:mb-0">
                <h3 className="text-3xl font-bold mb-4">Stop Buying Hardware.<br/>Start Mining Assets.</h3>
                <p className="text-gray-400">Join the decentralized energy grid. Manage your portfolio directly from your personalized Helios Dashboard.</p>
              </div>

              <div className="relative z-10">
                 <button onClick={goToCustomization} className="bg-white text-black px-8 py-4 rounded-full font-bold uppercase tracking-widest text-sm hover:bg-gray-200 hover:scale-105 transition-all shadow-[0_0_30px_rgba(255,255,255,0.2)] flex items-center gap-2">
      ...
      <footer className="bg-black border-t border-white/10 py-12 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center text-gray-600 text-xs font-medium uppercase tracking-widest">
          ...
          <div className="flex gap-6 mt-4 md:mt-0">
            ...
            <a href="#" className="hover:text-cyan-400 transition-colors">Smart Contract</a>
                ...
                <div className="space-y-12">
                  ...
                  <section>
                    <h3 className="text-xl font-bold text-cyan-400 mb-4 flex items-center gap-2">
                      <span className="w-8 h-[1px] bg-cyan-500/50"></span> THE PROBLEM
                    </h3>
                    <p className="text-gray-300 text-lg leading-relaxed font-light">
                      Homeowners face a "Blind Gamble" when adopting solar energy. Traditional installations are treated as <strong>sunk costs</strong> (hardware purchases) rather than <strong>liquid investments</strong>. Furthermore, unpredictable life events (moving, having kids, EV purchases) create financial anxiety, locking users into inflexible 10-20 year grid constraints.
                    </p>
                  </section>
                  ...
                  <section>
                    <h3 className="text-xl font-bold text-blue-400 mb-4 flex items-center gap-2">
                      <span className="w-8 h-[1px] bg-blue-500/50"></span> OUR SOLUTION
                    </h3>
                    <p className="text-gray-300 text-lg leading-relaxed font-light mb-6">
                      Helios transitions solar from a <strong className="text-white">Hardware Expense</strong> to a <strong className="text-white">Digital Asset</strong>. We built an end-to-end FinTech engine powered by spatial computing and AI.
                    </p>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="bg-white/5 border border-white/5 p-6 rounded-2xl">
                        <h4 className="text-white font-bold mb-2">1. AI Spatial Discovery</h4>
                        <p className="text-gray-400 text-sm">Gemini 2.5 cross-references life events with Google Maps 3D data to calculate hardware feasibility and 10-year yield projections.</p>
                      </div>
                      <div className="bg-white/5 border border-white/5 p-6 rounded-2xl">
                        <h4 className="text-white font-bold mb-2">2. ERU Assetization</h4>
                        <p className="text-gray-400 text-sm">Every kWh generated mints an Energy Revenue Unit (ERU). A fully liquid token that can be held as an inflation hedge or liquidated instantly for fiat cash.</p>
                      </div>
                    </div>
                  </section>
                  ...
                  <section>
                    <h3 className="text-xl font-bold text-purple-400 mb-4 flex items-center gap-2">
                      <span className="w-8 h-[1px] bg-purple-500/50"></span> THE IMPACT
                    </h3>
                    <p className="text-gray-300 text-lg leading-relaxed font-light">
                      By democratizing energy and providing real-time liquidity, Helios eliminates the barrier to entry for green energy. We are building the backbone of the decentralized, homeowner-owned electrical grid.
                    </p>
                  </section>

...
const SimulationPage = () => {
  ...
  const initialERU = assetData?.initial_grant_eru ? Number(assetData.initial_grant_eru) : fallbackInitialERU;
  ...
  const getSimulationData = () => {
    ...
    for (let i = 0; i <= simulationYear; i++) {
      ...
      let heliosValue = accumulatedSavings + (runningEruBalance * eruPegRate) - capex;
  ...
  const currentDataPoint = chartData[simulationYear] || { CurrentERU: initialERU, HeliosAsset: 0, Traditional: 0 };
             ...
             <div className="bg-black/80 backdrop-blur-2xl border border-white/10 rounded-[2.5rem] py-6 px-10 md:py-8 md:px-12 text-white shadow-2xl flex items-center justify-between">
                ...
                <div className="flex flex-1 justify-between items-center pr-12 border-r border-white/10">
                    <div className="text-center">
                        <div className="text-gray-400 text-[10px] md:text-xs uppercase tracking-[0.2em] mb-2">System Size</div>
                        <div className="text-xl md:text-3xl font-bold text-white font-mono">
                          {(isVirtual ? 5.4 : totalYield).toFixed(1)} <span className="text-sm font-normal opacity-50">kWp</span>
                        </div>
                    </div>

                    <div className="text-center">
                        <div className="text-gray-400 text-[10px] md:text-xs uppercase tracking-[0.2em] mb-2">Est. Savings</div>
                        <div className={`text-xl md:text-3xl font-bold transition-all font-mono ${hasBattery || isVirtual ? 'text-green-300 scale-110' : 'text-green-400'}`}>
                            RM {totalSavings.toLocaleString()}
                        </div>
                    </div>

                    <div className="text-center">
                        <div className="text-gray-400 text-[10px] md:text-xs uppercase tracking-[0.2em] mb-2">{isVirtual ? "Status" : "Panels"}</div>
                ...
                <div className="pl-12 shrink-0">
                    ...
                    >
                        <span className="tracking-[0.2em] uppercase text-xs md:text-sm">Deploy ERU</span>
                  ...
                  <div className="flex items-center gap-3 z-10">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-sm">
                        {step1Concern === "Relocation" ? "Relocate" : step1Concern === "EmptyNest" ? "Kids Move Out" : "Financial Crisis"}
